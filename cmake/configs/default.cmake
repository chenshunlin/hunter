...
hunter_config(Qt VERSION 5.9.1)
hunter_config(QtAndroidCMake VERSION 1.0.9)
hunter_config(QtCMakeExtra VERSION 1.0.23)
...
hunter_config(dlib VERSION 19.4-p2)
...
hunter_config(glfw VERSION 3.3.0-p2)
hunter_config(glm VERSION 0.9.8.5)
hunter_config(glog VERSION 0.3.5-p0)
...
hunter_config(libjson-rpc-cpp VERSION 0.7.0-p0)
hunter_config(libogg VERSION 1.3.2-cmake3)
hunter_config(libsodium VERSION 1.0.10)
hunter_config(libuv VERSION 2.0.0)
...
hunter_config(ogles_gpgpu VERSION 0.2.1)
